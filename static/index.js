window.PageWatchonly = Vue.defineAsyncComponent(async () => {
  await Promise.all([
    ...
    LNbits.utils.loadScript('/watchonly/static/js/bip39-word-list.js'),
    LNbits.utils.loadScript('/watchonly/static/js/crypto/noble-secp256k1.js'),
    LNbits.utils.loadScript('/watchonly/static/js/crypto/aes.js'),
    LNbits.utils.loadScript('/watchonly/static/js/lib/trezor-web-connect.js')
  ])
  window.TrezorConnect = window.trezor.default

  await Promise.all([
    LNbits.utils.loadScript('/watchonly/static/components/my-checkbox.js'),
    LNbits.utils.loadScript('/watchonly/static/components/wallet-config.js'),
    LNbits.utils.loadScript('/watchonly/static/components/wallet-list.js'),
    LNbits.utils.loadScript('/watchonly/static/components/address-list.js'),
    LNbits.utils.loadScript('/watchonly/static/components/history.js'),
    LNbits.utils.loadScript('/watchonly/static/components/utxo-list.js'),
    LNbits.utils.loadScript('/watchonly/static/components/fee-rate.js'),
    LNbits.utils.loadScript('/watchonly/static/components/seed-input.js'),
    LNbits.utils.loadScript('/watchonly/static/components/send-to.js'),
    LNbits.utils.loadScript('/watchonly/static/components/payment.js'),
    LNbits.utils.loadScript('/watchonly/static/components/serial-signer.js'),
    LNbits.utils.loadScript('/watchonly/static/components/trezor-signer.js'),
    LNbits.utils.loadScript(
      '/watchonly/static/components/serial-port-config.js'
    )
  ])

  return {
    name: 'PageWatchonly',
    template: '#page-watchonly',
    data() {
      return {
        scan: {
          scanning: false,
